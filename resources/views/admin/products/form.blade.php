            ...
            <form method="POST"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="product_id" name="product_id" class="form-control"
                           ...
                           {{ $product ? 'readonly' : 'readonly required' }}>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select id="category" name="category" class="form-select" required>
                        ...
                        <option value="Coffee" @selected($category === 'Coffee')>Coffee</option>
                        <option value="Milk Tea" @selected($category === 'Milk Tea')>Milk Tea</option>
                    </select>
                </div>
